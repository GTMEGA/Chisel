...
public enum Features {
    ...
    ALUMINUM {
        ...
        void addBlocks() {
            ...
            aluminum.carverHelper.addVariation("tile.metalOre.3.desc", 3, "metals/aluminum/machine", 23);
            aluminum.carverHelper.addVariation("tile.metalOre.4.desc", 4, "metals/aluminum/badGreggy", 24);
            aluminum.carverHelper.addVariation("tile.metalOre.5.desc", 5, "metals/aluminum/bolted", 25);
            aluminum.carverHelper.addVariation("tile.metalOre.6.desc", 6, "metals/aluminum/scaffold", 26);
            ...
            aluminumStairs.carverHelper.addVariation("tile.metalOre.3.desc", 3, "metals/aluminum/machine");
            aluminumStairs.carverHelper.addVariation("tile.metalOre.4.desc", 4, "metals/aluminum/badGreggy");
    ...
    BRONZE {
        ...
        void addBlocks() {
            ...
            bronze.carverHelper.addVariation("tile.metalOre.3.desc", 3, "metals/bronze/machine", 23);
            bronze.carverHelper.addVariation("tile.metalOre.4.desc", 4, "metals/bronze/badGreggy", 24);
            bronze.carverHelper.addVariation("tile.metalOre.5.desc", 5, "metals/bronze/bolted", 25);
            bronze.carverHelper.addVariation("tile.metalOre.6.desc", 6, "metals/bronze/scaffold", 26);
    ...
    CARPET_FLOOR {
        @Override
        void addBlocks() {
            BlockCarvableCarpet carpet = (BlockCarvableCarpet) new BlockCarvableCarpet(Material.cloth).setCreativeTab(ChiselTabs.tabOtherChiselBlocks).setHardness(0.1F)
                    .setStepSound(Block.soundTypeCloth).setLightOpacity(0).setStepSound(Block.soundTypeCloth);
    ...
    COBALT {
        ...
        void addBlocks() {
            ...
            cobalt.carverHelper.addVariation("tile.metalOre.6.desc", 6, "metals/cobalt/scaffold", 26);
    ...
    CONCRETE {
        ...
        @Override
        void addRecipes() {
            Block concreteRecipeBlock = Block.getBlockFromName(
                    Configurations.config.get("tweaks", "concrete recipe block", "gravel", "Unlocalized name of the block that, when burned, will produce concrete (examples: lightgem, stone)")
                            .getString());
    ...
    COPPER {
        ...
        void addBlocks() {
            ...
            copper.carverHelper.addVariation("tile.metalOre.3.desc", 3, "metals/copper/machine", 23);
            copper.carverHelper.addVariation("tile.metalOre.4.desc", 4, "metals/copper/badGreggy", 24);
            copper.carverHelper.addVariation("tile.metalOre.5.desc", 5, "metals/copper/bolted", 25);
            copper.carverHelper.addVariation("tile.metalOre.6.desc", 6, "metals/copper/scaffold", 26);
    ...
    DIAMOND_BLOCK {
        ...
        void addBlocks() {
            ...
            BlockCarvable diamond_block = (BlockBeaconBase) new BlockBeaconBase().setCreativeTab(ChiselTabs.tabOtherChiselBlocks).setHardness(5F).setResistance(10F).setStepSound(Block
                    .soundTypeMetal);
    ...
    ELECTRUM {
        @Override
        void addBlocks() {
            BlockCarvable electrum = (BlockCarvable) new BlockBeaconBase(Material.iron).setStepSound(Block.soundTypeMetal).setCreativeTab(ChiselTabs.tabModdedChiselBlocks).setHardness(5F)
                    .setResistance(10F);
            electrum.carverHelper.addVariation("tile.metalOre.0.desc", 0, "metals/electrum/caution", 20);
            electrum.carverHelper.addVariation("tile.metalOre.1.desc", 1, "metals/electrum/crate", 21);
            electrum.carverHelper.addVariation("tile.metalOre.2.desc", 2, "metals/electrum/thermal", 22);
            electrum.carverHelper.addVariation("tile.metalOre.3.desc", 3, "metals/electrum/machine", 23);
            electrum.carverHelper.addVariation("tile.metalOre.4.desc", 4, "metals/electrum/badGreggy", 24);
            electrum.carverHelper.addVariation("tile.metalOre.5.desc", 5, "metals/electrum/bolted", 25);
            electrum.carverHelper.addVariation("tile.metalOre.6.desc", 6, "metals/electrum/scaffold", 26);
            electrum.carverHelper.registerAll(electrum, "electrumblock");
            Carving.chisel.registerOre("electrumblock", "blockElectrum");
        }
    },
    ...
    FUTURA {
        ...
        void addBlocks() {
            ...
            futura.carverHelper.addVariation("tile.futura.0.desc", 0, SubmapMultiManager.ofGlowCTM("futura/screenMetallic"));
            futura.carverHelper.addVariation("tile.futura.1.desc", 1, SubmapMultiManager.ofGlowCTM("futura/screenCyan"));
            futura.carverHelper.addVariation("tile.futura.2.desc", 2, SubmapMultiManager.ofGlowFakeController("futura/controller"));
            futura.carverHelper.addVariation("tile.futura.3.desc", 3, SubmapMultiManager.ofGlow("futura/wavy"));
            futura.carverHelper.addVariation("tile.futura.4.desc", 4, SubmapMultiManager.ofGlowFakeController("futura/controllerPurple"));
            futura.carverHelper.addVariation("tile.futura.5.desc", 5, SubmapMultiManager.ofGlowFakeController("futura/uberWavy"));
    ...
    GOLD_BLOCK {
        ...
        void addBlocks() {
            ...
            gold2.carverHelper.addVariation("tile.metalOre.3.desc", 3, "metals/gold/machine", 23);
            gold2.carverHelper.addVariation("tile.metalOre.4.desc", 4, "metals/gold/badGreggy", 24);
            ;
            gold2.carverHelper.addVariation("tile.metalOre.5.desc", 5, "metals/gold/bolted", 25);
            gold2.carverHelper.addVariation("tile.metalOre.6.desc", 6, "metals/gold/scaffold", 26);
...
//			greatwoodplanks.carverHelper.addVariation("tile.greatwoodplanks.7.desc", 7, "greatwood/greatwood8");
    ...
    INVAR {
        @Override
        void addBlocks() {
            BlockCarvable invar = (BlockCarvable) new BlockBeaconBase(Material.iron).setStepSound(Block.soundTypeMetal).setCreativeTab(ChiselTabs.tabModdedChiselBlocks).setHardness(5F)
                    .setResistance(10F);
            invar.carverHelper.addVariation("tile.metalOre.0.desc", 0, "metals/invar/caution", 20);
            invar.carverHelper.addVariation("tile.metalOre.1.desc", 1, "metals/invar/crate", 21);
            invar.carverHelper.addVariation("tile.metalOre.2.desc", 2, "metals/invar/thermal", 22);
            invar.carverHelper.addVariation("tile.metalOre.3.desc", 3, "metals/invar/machine", 23);
            invar.carverHelper.addVariation("tile.metalOre.4.desc", 4, "metals/invar/badGreggy", 24);
            invar.carverHelper.addVariation("tile.metalOre.5.desc", 5, "metals/invar/bolted", 25);
            invar.carverHelper.addVariation("tile.metalOre.6.desc", 6, "metals/invar/scaffold", 26);
    ...
    IRON_BLOCK {
        ...
        void addBlocks() {
            ...
            iron2.carverHelper.addVariation("tile.metalOre.3.desc", 3, "metals/iron/machine", 23);
            iron2.carverHelper.addVariation("tile.metalOre.4.desc", 4, "metals/iron/badGreggy", 24);
            iron2.carverHelper.addVariation("tile.metalOre.5.desc", 5, "metals/iron/bolted", 25);
            iron2.carverHelper.addVariation("tile.metalOre.6.desc", 6, "metals/iron/scaffold", 26);
    ...
    LEAD {
        ...
        void addBlocks() {
            ...
            lead.carverHelper.addVariation("tile.metalOre.3.desc", 3, "metals/lead/machine", 23);
            lead.carverHelper.addVariation("tile.metalOre.4.desc", 4, "metals/lead/badGreggy", 24);
            lead.carverHelper.addVariation("tile.metalOre.5.desc", 5, "metals/lead/bolted", 25);
            lead.carverHelper.addVariation("tile.metalOre.6.desc", 6, "metals/lead/scaffold", 26);
    ...
    NICKEL {
        @Override
        void addBlocks() {
            BlockCarvable nickel = (BlockCarvable) new BlockBeaconBase(Material.iron).setStepSound(Block.soundTypeMetal).setCreativeTab(ChiselTabs.tabModdedChiselBlocks).setHardness(5F)
                    .setResistance(10F);
            nickel.carverHelper.addVariation("tile.metalOre.0.desc", 0, "metals/nickel/caution", 20);
            nickel.carverHelper.addVariation("tile.metalOre.1.desc", 1, "metals/nickel/crate", 21);
            nickel.carverHelper.addVariation("tile.metalOre.2.desc", 2, "metals/nickel/thermal", 22);
            nickel.carverHelper.addVariation("tile.metalOre.3.desc", 3, "metals/nickel/machine", 23);
            nickel.carverHelper.addVariation("tile.metalOre.4.desc", 4, "metals/nickel/badGreggy", 24);
            nickel.carverHelper.addVariation("tile.metalOre.5.desc", 5, "metals/nickel/bolted", 25);
            nickel.carverHelper.addVariation("tile.metalOre.6.desc", 6, "metals/nickel/scaffold", 26);
    ...
    PLATINUM {
        @Override
        void addBlocks() {
            BlockCarvable platinum = (BlockCarvable) new BlockBeaconBase(Material.iron).setStepSound(Block.soundTypeMetal).setCreativeTab(ChiselTabs.tabModdedChiselBlocks).setHardness(5F)
                    .setResistance(10F);
            platinum.carverHelper.addVariation("tile.metalOre.0.desc", 0, "metals/platinum/caution", 20);
            platinum.carverHelper.addVariation("tile.metalOre.1.desc", 1, "metals/platinum/crate", 21);
            platinum.carverHelper.addVariation("tile.metalOre.2.desc", 2, "metals/platinum/thermal", 22);
            platinum.carverHelper.addVariation("tile.metalOre.3.desc", 3, "metals/platinum/machine", 23);
            platinum.carverHelper.addVariation("tile.metalOre.4.desc", 4, "metals/platinum/badGreggy", 24);
            platinum.carverHelper.addVariation("tile.metalOre.5.desc", 5, "metals/platinum/bolted", 25);
            platinum.carverHelper.addVariation("tile.metalOre.6.desc", 6, "metals/platinum/scaffold", 26);
    ...
    PRISMARINE {
        ...
        void addBlocks() {
            ...
            prismarine.carverHelper
                    .addVariation("tile.prismarine.7.desc", 7, "prismarine/diagonal/prismarineDiagonalAnim", new SubmapManagerCombinedCTM(4, "prismarine/diagonal/prismarineDiagonalAnim", TextureType.V4),
                            -13);
    ...
    SILVER {
        ...
        void addBlocks() {
            ...
            silver.carverHelper.addVariation("tile.metalOre.3.desc", 3, "metals/silver/machine", 23);
            silver.carverHelper.addVariation("tile.metalOre.4.desc", 4, "metals/silver/badGreggy", 24);
            silver.carverHelper.addVariation("tile.metalOre.5.desc", 5, "metals/silver/bolted", 25);
            silver.carverHelper.addVariation("tile.metalOre.6.desc", 6, "metals/silver/scaffold", 26);
    ...
    SMASHING_ROCK {
        ...
        @Override
        void addRecipes() {
            GameRegistry.addShapelessRecipe(new ItemStack(ChiselItems.smashingrock, 16),
                    new Object[]{new ItemStack(Items.stone_pickaxe), new ItemStack(Items.glass_bottle, 1), new ItemStack(Items.stone_shovel)});
        }
    },
    ...
    SNAKE_SANDSTONE(SANDSTONE) {
        @Override
        void addBlocks() {
            BlockSnakestone sand_snakestone = (BlockSnakestone) new BlockSnakestone("Chisel:snakestone/sandsnake/").setCreativeTab(ChiselTabs.tabStoneChiselBlocks)
                    .setBlockName("chisel.snakestoneSand");
    ...
    SNAKESTONE {
        @Override
        void addBlocks() {
            BlockSnakestone stone_snakestone = (BlockSnakestone) new BlockSnakestone("Chisel:snakestone/snake/").setBlockName("chisel.snakestoneStone").setCreativeTab(ChiselTabs
                    .tabStoneChiselBlocks);
    ...
    STEEL {
        ...
        void addBlocks() {
            ...
            steel.carverHelper.addVariation("tile.metalOre.3.desc", 3, "metals/steel/machine", 23);
            steel.carverHelper.addVariation("tile.metalOre.4.desc", 4, "metals/steel/badGreggy", 24);
            steel.carverHelper.addVariation("tile.metalOre.5.desc", 5, "metals/steel/bolted", 25);
            steel.carverHelper.addVariation("tile.metalOre.6.desc", 6, "metals/steel/scaffold", 26);
    ...
    STONE_BRICK {
        ...
        void addBlocks() {
            ...
            if (Configurations.allowSmoothStone) {
                Carving.chisel.addVariation("stonebricksmooth", Blocks.stone, 0, -3);
                Carving.chisel.addVariation("stonebricksmooth", Blocks.double_stone_slab, 0, -2);
                Carving.chisel.addVariation("stonebricksmooth", Blocks.double_stone_slab, 8, -1);
            }
            for (int i = 0; i < 4; i++) {
            ...
            stonebricksmooth.carverHelper.addVariation("tile.stonebricksmooth.0.desc", 0, "stonebrick2/masonry2Neutral", 16);
            stonebricksmooth.carverHelper.addVariation("tile.stonebricksmooth.1.desc", 1, "stonebrick2/masonry2Blue", 17);
            stonebricksmooth.carverHelper.addVariation("tile.stonebricksmooth.2.desc", 2, "stonebrick2/masonry2Red", 18);
            stonebricksmooth.carverHelper.addVariation("tile.stonebricksmooth.3.desc", 3, "stonebrick2/masonry2Both", 19);
    ...
    TECHNICAL {
        ...
        void addRecipes() {
            GameRegistry
                    .addRecipe(new ShapedOreRecipe(new ItemStack(ChiselBlocks.technical, Configurations.factoryBlockAmount, 0), new Object[]{"xyx", "yxy", "xyx", 'x', "stone", 'y', Items.iron_ingot
                    }));
            /*
    ...
    URANIUM /* Whose ranium? */ {
        ...
        void addBlocks() {
            ...
            uranium.carverHelper.addVariation("tile.metalOre.3.desc", 3, "metals/uranium/machine", 23);
            uranium.carverHelper.addVariation("tile.metalOre.4.desc", 4, "metals/uranium/badGreggy", 24);
            uranium.carverHelper.addVariation("tile.metalOre.5.desc", 5, "metals/uranium/bolted", 25);
            uranium.carverHelper.addVariation("tile.metalOre.6.desc", 6, "metals/uranium/scaffold", 26);
    ...
    VOIDSTONE {
        ...
        void addBlocks() {
            ...
            BlockCarvable voidstone2 = (BlockCarvable) new BlockCarvable().setStepSound(Block.soundTypeStone).setCreativeTab(ChiselTabs.tabStoneChiselBlocks).setHardness(5.0F).setResistance(10.0F);
    ...
    SLATE {
        @Override
        void addBlocks() {
            BlockCarvable slate = (BlockCarvable) new BlockCarvable(Material.rock).setHardness(2.0F).setResistance(10.0F).setCreativeTab(ChiselTabs.tabModdedChiselBlocks);
            for (int i = 0; i < 16; i++) {
                slate.carverHelper.addVariation("tile.slate." + i + ".desc", i, "zc/slate/slate1_" + i);
            }
            ...
            slate2.carverHelper.registerVariations("slate");
            //Undefined Colors or Texture Variations... Possible lights or Pathways
//            BlockCarvable slate3 = (BlockCarvable) new BlockCarvable(Material.rock).setHardness(2.0F).setResistance(10.0F).setCreativeTab(ChiselTabs.tabModdedChiselBlocks);
//            for (int i = 0; i < 16; i++) {
//                slate3.carverHelper.addVariation("tile.slate3." + i + ".desc", i, "zc/slate/slate3_" + i);
//            }
//
//            slate3.carverHelper.registerBlock(slate3, "slate3");
//            slate3.carverHelper.registerVariations("slate");
//            BlockCarvable slate4 = (BlockCarvable) new BlockCarvable(Material.rock).setHardness(2.0F).setResistance(10.0F).setCreativeTab(ChiselTabs.tabModdedChiselBlocks);
//            for (int i = 0; i < 16; i++) {
//                slate4.carverHelper.addVariation("tile.slate4." + i + ".desc", i, "zc/slate/slate4_" + i);
//            }
//            slate4.carverHelper.registerBlock(slate4, "slate4");
//            slate4.carverHelper.registerVariations("slate");
 ...
 //           BlockCarvable nibble2 = (BlockCarvable) new BlockCarvable(Material.rock).setStepSound(Block.soundTypeStone).setCreativeTab(ChiselTabs.tabModdedChiselBlocks).setHardness(2.0F).setResistance(10.0F).setCreativeTab(ChiselTabs.tabModdedChiselBlocks);
    ...
    PIXEL {
        ...
        void addBlocks() {
            ...
            for (int i = 0; i < 16; i++) {
                pixel.carverHelper.addVariation("tile.pixel2." + i + ".desc", i, "zc/pixel/pixel2_" + i);
